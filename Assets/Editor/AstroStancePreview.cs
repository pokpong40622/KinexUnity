...
{
    /// <summary>
    /// Renders each AstroStance UI state (intro / framing / hud / results) to a PNG so the
    ...
    /// Batch: -executeMethod Kinex.AstroStance.EditorTools.AstroStancePreview.RenderAll
    /// </summary>
    public static class AstroStancePreview
    {
        ...
        public static void RenderProps()
        {
            ...
            Place(Kinex.AstroStance.AstroProps.Meteor(), new Vector3(-1.5f, 0.5f, 2.3f));
            Place(Kinex.AstroStance.AstroProps.Treasure(), new Vector3(0f, 0f, 2.0f));
            Place(Kinex.AstroStance.AstroProps.KickRing(thai), new Vector3(1.5f, 0.4f, 2.3f));
            Place(Kinex.AstroStance.AstroProps.GrabberTool(), new Vector3(0.95f, 1.05f, 0.5f));
            ...
            Debug.Log("[AstroStancePreview] rendered props parade");
        ...
        public static void RenderAll()
        {
            ...
            void PrepFraming()
            {
                var promptField = typeof(AstroStanceDirector).GetField("framingPromptText",
                    System.Reflection.BindingFlags.Public | System.Reflection.BindingFlags.Instance);
                var chipsField = typeof(AstroStanceDirector).GetField("framingChips",
                    System.Reflection.BindingFlags.Public | System.Reflection.BindingFlags.Instance);
            ...
            void PrepResults()
            {
                ...
                var starsField = typeof(AstroStanceDirector).GetField("resultStars",
                    System.Reflection.BindingFlags.Public | System.Reflection.BindingFlags.Instance);
                if (starsField?.GetValue(director) is Image[] stars)
                    for (int i = 0; i < stars.Length; i++)
                        if (stars[i] != null)
                            stars[i].color = i < 2 ? new Color(1f, 0.82f, 0.33f) : new Color(1f, 1f, 1f, 0.18f);
                var repField = typeof(AstroStanceDirector).GetField("resultRepValues",
                    System.Reflection.BindingFlags.Public | System.Reflection.BindingFlags.Instance);
            ...
            Debug.Log("[AstroStancePreview] rendered intro/framing/hud/results");
            EditorApplication.Exit(0);
        }
