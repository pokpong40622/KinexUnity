...
{
    /// <summary>
    /// Calibration-free sit/stand classifier used by TheDasher ONLY (the shared
    ...
    ///
    /// Measured on the recorded tablet feeds (Assets/TheDasher/TestFeeds): the sit dips the ratio
    ...
    /// </summary>
    public class DasherSitClassifier
    {
